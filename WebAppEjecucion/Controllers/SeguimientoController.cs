    ...
    public class SeguimientoController : Controller
    {
        ...
        public ActionResult Index(int? id)
        {
            ...
            var seguimiento = db.Database.SqlQuery<RelacionSeguimientoPersona>
                (@"SELECT resultado.Obra,iif(resultado.FechaSeguimiento is null, '1999-01-01',resultado.FechaSeguimiento) as FechaSeguimiento,resultado.EstadoObra,resultado.Inspector,resultado.IdSeguimiento
